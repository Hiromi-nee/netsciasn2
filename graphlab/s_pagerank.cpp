...
int main(int argc, char** argv) {
  ...
  clopts.attach_option("format", format, "graph file format");
  clopts.attach_option("engine", exec_type, "Synchronous or asynchronous");
  clopts.attach_option("tol", TOLERANCE, "The permissible change at convergence.");
  std::string saveprefix;
  clopts.attach_option("saveprefix", saveprefix, "prefix of outfile");
